...
class FullTimeEmployee(Employee):
    def get_unpaid_vacation(self, data_begin:str, num_days_vacation: int):
        return f'Начало неоплачиваемого отпуска: {data_begin}, продолжительность: {num_days_vacation} дней.'
